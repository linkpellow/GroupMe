...
const CalendlyIntegration: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const checkCalendlyIntegration = async () => {
      try {
        ...
        const response = await axiosInstance.('/integrations/calendly');
  ...
  const handleDisconnect = async () => {
    setIsLoading(true);
    try {
      await axiosInstance.('/integrations/calendly');
      setCalendlyToken('');
      setCalendlyUser('');
  ...
  const handleAddEvent = async () => {
    ...
    try {
      ...
      try {
        await axiosInstance.('/integrations/calendly/events', {
...
const TextDripIntegration: React.FC = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      setIsLoading(true);
      await axiosInstance.('/textdrip/connect', { baseUrl, email, password, apiKey });
