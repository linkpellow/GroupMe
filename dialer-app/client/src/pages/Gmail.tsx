...
const Gmail: React.FC = () => {
  ...
  const checkConnectionStatus = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get('gmail/status');
  ...
  const connectGmail = async () => {
    try {
      const response = await axiosInstance.get('gmail/auth-url');
  ...
  const disconnectGmail = async () => {
    try {
      await axiosInstance.post('gmail/disconnect');
  ...
  const fetchLabels = async () => {
    try {
      const response = await axiosInstance.get('gmail/labels');
  ...
  const fetchEmails = async (pageToken?: string) => {
    try {
      ...
      const response = await axiosInstance.get('gmail/messages', {
        params: {
  ...
  const sendEmailToLead = async (
    ...
    try {
      ...
      await axiosInstance.post('gmail/send', {
        to: lead.email,
  ...
  const processSingleMarketplaceLead = async () => {
    try {
      ...
      const response = await axiosInstance.post('gmail/process-single-marketplace-lead');
