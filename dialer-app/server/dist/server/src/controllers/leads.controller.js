...
const getLeadsStats = async (req, res) => {
    try {
        ...
        const stats = await Promise.race([
            ...
            new Promise((_, reject) => setTimeout(() => reject(new Error('Stats query timeout')), 5000))
        ]);
...
exports.getLeadsStats = getLeadsStats;
