...
const sourceCodeQualitySchema = new mongoose_1.Schema({
    userId: {
...
const SourceCodeQualityModel = mongoose_1.default.model('SourceCodeQuality', sourceCodeQualitySchema);
exports.default = SourceCodeQualityModel;
