...
async function updateLeads() {
    try {
        await mongoose_1.default.connect('mongodb+srv://linkpellowinsurance:9526Toast$@linkpellow.ygw6y.mongodb.net/dialer_app?retryWrites=true&w=majority&appName=linkpellow');
        console.log('Connected to MongoDB');
        // Update Walter Currence's lead
        await Lead_1.default.findOneAndUpdate({
            $or: [
                { phone: '8645907432' },
        ...
        await Lead_1.default.updateMany({
            name: 'Unknown Name',
            createdAt: { $gte: today },
        }, {
            $set: {
